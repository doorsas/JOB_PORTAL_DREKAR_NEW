    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_file', models.FileField(blank=True, help_text='The signed PDF document.', null=True, upload_to='contracts/%Y/%m/')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('INVOICE_REMINDER', 'Invoice Reminder'), ('STATUS_UPDATE', 'Status Update'), ('APPLICATION_UPDATE', 'Application Update'), ('PAYSLIP_READY', 'Payslip Ready')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.CharField(choices=[('BANK_TRANSFER', 'Bank Transfer'), ('XML_INTEGRATION', 'XML Integration'), ('CREDIT_CARD', 'Credit Card')], max_length=20)),
